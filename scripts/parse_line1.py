...
# 승강장이 아닌 통과 지점 (선로 분기점·신호장 등) — 역 마스터에서 제외
# 마전(경원선 양주~덕계 사이)은 여객취급 안 하는 신호장 — 전 트립에서 전부 pass만
# 있고 stop/origin/destination 0건으로 확인(2026-08-29). 이름이 인천2호선 마전역과
# 우연히 같아 station_groups에서 잘못 병합돼 있었는데, JUNCTIONS로 빼면 해소된다.
JUNCTIONS = {"시흥연": "시흥연결선", "마전": "마전신호장"}
